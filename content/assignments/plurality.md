...
* Click [plurality.c](/web/plurality.c) to download the starting code to your computer.
* Drag the `plurality.c` file from your computer and drop it on the folder in your IDE.
